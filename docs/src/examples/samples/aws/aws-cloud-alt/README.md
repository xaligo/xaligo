# `aws-cloud-alt` — AWS Cloud

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![AWS Cloud](sample.svg)
...
- Default catalog ID: 1864. Covered catalog IDs: 1864.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-cloud-alt
```
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-cloud-alt`。通常の再描画は XAL/README を上書きしない。
