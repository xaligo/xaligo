# `aws-sqs-queue` — Amazon Simple Queue Service Queue

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![Amazon Simple Queue Service Queue](sample.svg)
...
- Default catalog ID: 1508. Covered catalog IDs: 1508.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-sqs-queue
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `resource-schema`。サービス文脈: [`aws-sqs`](../aws-sqs/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-sqs-queue`。通常の再描画は XAL/README を上書きしない。
