# `aws-marketplace-dark` — AWS Marketplace Dark

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![AWS Marketplace Dark](sample.svg)

AWS service icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `service`; category: General Icons.
- Diagram scope: `service` (recommendation, not AWS deployment validation).
- Default catalog ID: 539. Covered catalog IDs: 533, 535, 537, 539.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-marketplace-dark
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `api-context`。サービス文脈: [`aws-marketplace-dark`](../aws-marketplace-dark/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-marketplace-dark`。通常の再描画は XAL/README を上書きしない。
