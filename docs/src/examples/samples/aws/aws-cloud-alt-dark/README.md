# `aws-cloud-alt-dark` — AWS Cloud (dark icon)

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![AWS Cloud (dark icon)](sample.svg)
...
- Default catalog ID: 1865. Covered catalog IDs: 1865.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-cloud-alt-dark
```
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-cloud-alt-dark`。通常の再描画は XAL/README を上書きしない。
