# `aws-rds-trusted-language-extensions-for-postgresql` — Amazon RDS Trusted Language Extensions for PostgreSQL

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![Amazon RDS Trusted Language Extensions for PostgreSQL](sample.svg)

AWS resource icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `resource`; category: Database.
- Diagram scope: `logical` (recommendation, not AWS deployment validation).
- Default catalog ID: 1832. Covered catalog IDs: 1832.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-rds-trusted-language-extensions-for-postgresql
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `service-context`。サービス文脈: [`aws-rds`](../aws-rds/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-rds-trusted-language-extensions-for-postgresql`。通常の再描画は XAL/README を上書きしない。
