# `aws-outposts-family` — AWS Outposts family

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![AWS Outposts family](sample.svg)

AWS service icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `service`; category: Compute.
- Diagram scope: `service` (recommendation, not AWS deployment validation).
- Default catalog ID: 91. Covered catalog IDs: 16, 41, 66, 91.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-outposts-family
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `service-context`。サービス文脈: [`aws-outposts-family`](../aws-outposts-family/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-outposts-family`。通常の再描画は XAL/README を上書きしない。
