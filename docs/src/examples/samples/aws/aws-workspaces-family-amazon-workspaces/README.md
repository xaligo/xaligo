# `aws-workspaces-family-amazon-workspaces` — Amazon WorkSpaces Family Amazon WorkSpaces

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![Amazon WorkSpaces Family Amazon WorkSpaces](sample.svg)

AWS resource icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `resource`; category: End User Computing.
- Diagram scope: `logical` (recommendation, not AWS deployment validation).
- Default catalog ID: 1464. Covered catalog IDs: 1464.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-workspaces-family-amazon-workspaces
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `resource-schema`。サービス文脈: [`aws-workspaces-family`](../aws-workspaces-family/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-workspaces-family-amazon-workspaces`。通常の再描画は XAL/README を上書きしない。
