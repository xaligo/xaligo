...
![Amazon VPC Endpoints](sample.svg)

Icon-only logical VPC boundary attachment. side/anchor/offset move the icon along the border, outside normal flow. Endpoint placement is a diagram convention, not the physical location of endpoint network interfaces.

- Kind: `resource`; category: Networking Content Delivery.
- Diagram scope: `vpc-boundary` (recommendation, not AWS deployment validation).
- Default catalog ID: 1579. Covered catalog IDs: 1579.
- Implementation: V1 and V2; icon-only boundary port, excluded from normal layout flow.

## Parameters

`id` is required. `side` = top/right/bottom/left (default right); `anchor` = 0..1; `offset` = finite tangent displacement; `size` > 0 (default 48). The tag must be an empty direct child of `<vpc>`. Functional annotations are preserved in source/project metadata; the boundary icon has no text label.

`detail` adds a free-form diagram annotation. `show-details="false"` hides annotation text. Only supplied values are shown; none are sent to AWS. Service/resource annotations appear on separate wrapped lines.

| Parameter | Type | Meaning | Example |
|---|---|---|---|
| `endpoint-type` | `interface` / `gateway` / `gateway-load-balancer` | Logical endpoint type annotation | `interface` |
| `service-name` | text | Endpoint service annotation | `com.amazonaws.ap-northeast-1.s3` |
...
### 構成モデル: `AWS::EC2::VPCEndpoint`

[公式リファレンス](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html)。全 14 プロパティを型付きで列挙します（表示カードには主要項目のみ）。

| Field | Type | Required in AWS schema |
|---|---|---|
| [DnsOptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-dnsoptions) | `DnsOptionsSpecification` | no |
| [IpAddressType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-ipaddresstype) | `String` | no |
| [PolicyDocument](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-policydocument) | `Json` | no |
| [PrivateDnsEnabled](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-privatednsenabled) | `Boolean` | no |
| [ResourceConfigurationArn](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-resourceconfigurationarn) | `String` | no |
| [RouteTableIds](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-routetableids) | `List<String>` | no |
| [SecurityGroupIds](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-securitygroupids) | `List<String>` | no |
| [ServiceName](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-servicename) | `String` | no |
| [ServiceNetworkArn](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-servicenetworkarn) | `String` | no |
| [ServiceRegion](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-serviceregion) | `String` | no |
| [SubnetIds](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-subnetids) | `List<String>` | no |
| [Tags](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-tags) | `List<Tag>` | no |
| [VpcEndpointType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-vpcendpointtype) | `String` | no |
| [VpcId](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html#cfn-ec2-vpcendpoint-vpcid) | `String` | yes |

#### DnsOptions → `AWS::EC2::VPCEndpoint.DnsOptionsSpecification`

| Field | Type | Required in AWS schema |
|---|---|---|
| [DnsRecordIpType](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-vpcendpoint-dnsoptionsspecification.html#cfn-ec2-vpcendpoint-dnsoptionsspecification-dnsrecordiptype) | `String` | no |
| [PrivateDnsOnlyForInboundResolverEndpoint](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-vpcendpoint-dnsoptionsspecification.html#cfn-ec2-vpcendpoint-dnsoptionsspecification-privatednsonlyforinboundresolverendpoint) | `String` | no |
| [PrivateDnsPreference](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-vpcendpoint-dnsoptionsspecification.html#cfn-ec2-vpcendpoint-dnsoptionsspecification-privatednspreference) | `String` | no |
| [PrivateDnsSpecifiedDomains](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-vpcendpoint-dnsoptionsspecification.html#cfn-ec2-vpcendpoint-dnsoptionsspecification-privatednsspecifieddomains) | `List<String>` | no |
...
- [公式資料 1](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpoint.html)
...
- 編集後は `npm run generate:aws-samples -- --render --tag=vpc-endpoint`。通常の再描画は XAL/README を上書きしない。
