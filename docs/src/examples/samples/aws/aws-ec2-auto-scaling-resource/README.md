# `aws-ec2-auto-scaling-resource` — Amazon EC2 Auto Scaling

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![Amazon EC2 Auto Scaling](sample.svg)

AWS resource icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `resource`; category: Compute.
- Diagram scope: `logical` (recommendation, not AWS deployment validation).
- Default catalog ID: 1786. Covered catalog IDs: 1786.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-ec2-auto-scaling-resource
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `service-context`。サービス文脈: [`aws-ec2-auto-scaling`](../aws-ec2-auto-scaling/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-ec2-auto-scaling-resource`。通常の再描画は XAL/README を上書きしない。
