...
![Amazon Lookout for Metrics](sample.svg)

AWS service icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `service`; category: Artificial Intelligence.
- Diagram scope: `service` (recommendation, not AWS deployment validation).
- Default catalog ID: 984. Covered catalog IDs: 861, 902, 943, 984.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-lookout-for-metrics
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `product-guide`。サービス文脈: [`aws-lookout-for-metrics`](../aws-lookout-for-metrics/README.md)。
...
- [公式資料 1](https://docs.aws.amazon.com/whitepapers/latest/aws-overview/machine-learning.html)
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-lookout-for-metrics`。通常の再描画は XAL/README を上書きしない。
