...
API version: 2016-11-28. [Official AWS SDK source](https://github.com/boto/botocore/blob/develop/botocore/data/waf-regional/2016-11-28/service-2.json).
...
| Field | Type | Required in AWS schema |
|---|---|---|
| `WebACLSummary` | `WebACLSummary` | no |
