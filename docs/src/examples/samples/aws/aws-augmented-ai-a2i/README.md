# `aws-augmented-ai-a2i` — Amazon Augmented AI A2I

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![Amazon Augmented AI A2I](sample.svg)

AWS service icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `service`; category: Artificial Intelligence.
- Diagram scope: `service` (recommendation, not AWS deployment validation).
- Default catalog ID: 971. Covered catalog IDs: 848, 889, 930, 971.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-augmented-ai-a2i
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `service-context`。サービス文脈: [`aws-augmented-ai-a2i`](../aws-augmented-ai-a2i/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-augmented-ai-a2i`。通常の再描画は XAL/README を上書きしない。
