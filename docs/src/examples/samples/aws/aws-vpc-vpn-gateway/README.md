# `aws-vpc-vpn-gateway` — Amazon VPC VPN Gateway

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![Amazon VPC VPN Gateway](sample.svg)
...
- Default catalog ID: 1590. Covered catalog IDs: 1590.
...
|---|---|---|---|
| `attachment` | text | Attachment/route annotation | `Main VPC` |
...
```sh
npm run generate:aws-samples -- --render --tag=aws-vpc-vpn-gateway
```
...
### 構成モデル: `AWS::EC2::VPNGateway`

[公式リファレンス](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpngateway.html)。全 3 プロパティを型付きで列挙します（表示カードには主要項目のみ）。

| Field | Type | Required in AWS schema |
|---|---|---|
| [AmazonSideAsn](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpngateway.html#cfn-ec2-vpngateway-amazonsideasn) | `Long` | no |
| [Tags](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpngateway.html#cfn-ec2-vpngateway-tags) | `List<Tag>` | no |
| [Type](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpngateway.html#cfn-ec2-vpngateway-type) | `String` | yes |
...
- [公式資料 1](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpngateway.html)
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-vpc-vpn-gateway`。通常の再描画は XAL/README を上書きしない。
