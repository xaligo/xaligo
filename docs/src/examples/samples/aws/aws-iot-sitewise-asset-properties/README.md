# `aws-iot-sitewise-asset-properties` — AWS IoT SiteWise Asset Properties

[SVG preview](sample.svg) · [Editable XAL](sample.xal) · [Catalog](../README.md)

![AWS IoT SiteWise Asset Properties](sample.svg)

AWS resource icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `resource`; category: IoT.
- Diagram scope: `logical` (recommendation, not AWS deployment validation).
- Default catalog ID: 1362. Covered catalog IDs: 1362.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-iot-sitewise-asset-properties
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `service-context`。サービス文脈: [`aws-iot-sitewise`](../aws-iot-sitewise/README.md)。
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-iot-sitewise-asset-properties`。通常の再描画は XAL/README を上書きしない。
