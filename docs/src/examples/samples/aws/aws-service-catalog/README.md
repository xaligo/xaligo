...
![AWS Service Catalog](sample.svg)

AWS service icon. Use a label and explicit annotations to describe its role; scope is selected by the author.

- Kind: `service`; category: Management Governance.
- Diagram scope: `service` (recommendation, not AWS deployment validation).
- Default catalog ID: 687. Covered catalog IDs: 597, 627, 657, 687.
...
```sh
npm run generate:aws-samples -- --render --tag=aws-service-catalog
```

<!-- aws-functional-research:start -->
## 機能調査・構成デザイン（2026-09-06）

分類: `service-context`。サービス文脈: [`aws-service-catalog`](../aws-service-catalog/README.md)。
...
### 構成モデル: `AWS::ServiceCatalog::AcceptedPortfolioShare`

[公式リファレンス](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-acceptedportfolioshare.html)。全 2 プロパティを型付きで列挙します（表示カードには主要項目のみ）。

| Field | Type | Required in AWS schema |
|---|---|---|
| [AcceptLanguage](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-acceptedportfolioshare.html#cfn-servicecatalog-acceptedportfolioshare-acceptlanguage) | `String` | no |
| [PortfolioId](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-acceptedportfolioshare.html#cfn-servicecatalog-acceptedportfolioshare-portfolioid) | `String` | yes |
...
- [AWS Service Catalog: 90 操作の入力・出力一覧](../research/api/servicecatalog.md)（API version 2015-12-10）

### 出典・調査範囲

- [公式資料 1](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-acceptedportfolioshare.html)
- [公式資料 2](https://github.com/boto/botocore/blob/develop/botocore/data/servicecatalog/2015-12-10/service-2.json)
...
- 編集後は `npm run generate:aws-samples -- --render --tag=aws-service-catalog`。通常の再描画は XAL/README を上書きしない。
