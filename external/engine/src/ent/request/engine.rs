use crate::cnf::engine::{
    ABI_VERSION, BOOL_COLUMN_SPAN, BOOL_COLUMNS, BOOL_KNOWN, BOOL_LAYER, BOOL_PORT_VISIBLE,
    BOOL_ROW_SPAN, BOOL_TEXT_CLIP, BOOL_TEXT_FIT, BOOL_TEXT_WRAP, BOOL_VISIBLE,
    MAX_ELEMENTS, MAX_REQUEST_BYTES, NUMERIC_FIELD_COUNT, OPERATION_LAYOUT,
    OPERATION_NORMALIZE_SVG, OPERATION_SVG, REQUEST_MAGIC, STRING_FIELD_COUNT,
};
...
pub(crate) fn decode_request(input: &[u8]) -> Result<EngineRequest, String> {
