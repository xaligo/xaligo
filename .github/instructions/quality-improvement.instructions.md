...
| Q05.12 | in-progress | Improve component/deployment/package/composite-structure design quality: UML adornment placement, nested group padding, port readability, dependency routing, and package tab proportions. | `TestUMLComponentRendersComponentNotation`; component boxes render the two-rectangle UML component adornment using the existing xaligo deep-blue/white palette; regenerated `docs/src/images/uml-component.svg`; deployment/package/composite visual passes remain pending |
