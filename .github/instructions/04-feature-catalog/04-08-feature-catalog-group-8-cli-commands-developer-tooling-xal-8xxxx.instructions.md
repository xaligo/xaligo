...
| XAL-8000170 | `xaligo mcp` command | Planned | Exposes shared validation, rendering, icon, and project-search operations through MCP stdio and Streamable HTTP transports. |
