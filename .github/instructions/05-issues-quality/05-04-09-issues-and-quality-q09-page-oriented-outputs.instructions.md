...
# 05.04.09 Issues and quality: Q09 Page-Oriented Outputs
...
| Q09.2 | not-started | Verify `--combine-frames` behavior for SVG and PPTX. | CLI integration tests |
| Q09.3 | not-started | Confirm frame crop boundaries, hidden page-frame outlines, and marker safety behavior. | SVG/PPTX geometry checks |
