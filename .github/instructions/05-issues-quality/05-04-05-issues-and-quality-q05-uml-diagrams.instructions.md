...
| Q05.15 | not-started | Verify UML parity for every shared plan change across SVG, PPTX plan/export, and Markdown SVG embedding. | focused renderer matrix for changed UML contracts |
