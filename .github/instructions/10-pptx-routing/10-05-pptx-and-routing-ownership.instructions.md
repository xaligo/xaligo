...
| Native PPTX drawing/export | `external/exporter` Rust package and `pptx` adapter, linked into `external/engine` |
| PPTX C ABI entry | `external/exporter/src/ctl/exporter.rs` |
| Legacy V1 browser/JavaScript compatibility bridge | `cmd/wasm/main.go` |
